...
def parse_arch(arch, n_actions):
    if arch == "nature":
        ...
        return nn.Sequential(
            pnn.LargeAtariCNN(),
            init_chainer_default(nn.Linear(128, n_actions, bias=False)),
            SingleSharedBias(),
            DiscreteActionValueHead(),
        )
    elif arch == "nips":
...
def main():
    ...
    parser.add_argument("--n-best-episodes", type=int, default=20)
...
#"""
#python train_dqn_ale.py --env BreakoutNoFrameskip-v4 --demo --load results\20220415T153342.348676\30000_finish --eval-n-runs 2 --render
#python train_dqn_ale.py --env SuperMarioBros-1-1-v0 --demo --load results\20220415T190832.540934-run1-1M\1103610_except --render
#python train_dqn_ale.py --env SuperMarioBros-1-1-v0 --demo --load results\20220415T220139.525066-run1_1Mlong\3487660_except --render
#python train_dqn_ale.py --env SuperMarioBros-1-1-v0 --demo --load C:\Users\Staff\Downloads\pfrl-master\examples\atari\results\20220416T052508.927537-run2-1M\1237940_except --render
#python train_dqn_ale.py --env SuperMarioBros-1-1-v0 --demo --load C:\Users\Staff\Downloads\pfrl-master\examples\atari\results\20220416T082710.272291-run3-1M\1200150_except --render
#"""
