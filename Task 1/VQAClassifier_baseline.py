...
class VQA_Classifier(VQA_DataLoader):
    ...
    def build_classifier_model(self):
        ...
        img_input, vision_net = self.create_vision_encoder(num_projection_layers=1, projection_dims=32, dropout_rate=0.1)
        text_input, text_net = self.create_text_encoder(num_projection_layers=1, projection_dims=32, dropout_rate=0.1)
